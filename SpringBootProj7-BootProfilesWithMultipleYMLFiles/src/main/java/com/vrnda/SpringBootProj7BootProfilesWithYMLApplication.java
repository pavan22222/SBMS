...
public class SpringBootProj7BootProfilesWithYMLApplication {
	...
	public static void main(String[] args) {
		ApplicationContext ctx=SpringApplication.run(SpringBootProj7BootProfilesWithYMLApplication.class, args);
